...
export default function OrderPage() {
  ...
  return loading ? (
    ...
    <div>
      ...
      <a href='https://p2p.mirotalk.com/join/76018FastSnail' target='_blank' className='callBtn'>Chat With Owner</a>
      <button onClick={() => window.print()} className='buttonPrint'>
        Print Agreement &nbsp;
        <i className="fas fa-print light:hidden text-xl"></i>
    </button>
      <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
        <div className="flex justify-start item-start space-y-2 flex-col">
          <h1 className="text-3xl light:text-white lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800">
            ...
            Agreement Number: #{orderId}
          </h1>
          <span>Agreement Started On</span>
